...
**Version:** 0.5 · updated 2026-07-06
...
**Repo:** private `Valtora/Ostraplan`; **public flip in preparation** — this doc pass is part of that prep (§13).
...
- **`meta`** — name, author, notes, and UTC `created` / `modified` timestamps.
...
- Repo `Valtora/Ostraplan` — private during development, **public flip in preparation** (this doc pass + the README/usage/CHANGELOG rewrite and the missing-mods faithfulness fix are the prep).
...
- Public-flip checklist: **[done]** MIT `LICENSE`; **[done]** README credits Blue Bottle Games and states the fan-tool / asset policy; **[done]** user-facing `docs/usage.md` + `CHANGELOG.md`; **[in progress]** hygiene re-check of engine-file headers; **[pending]** flip `Valtora/Ostraplan` to public + cut the first `Ostraplan.exe` release, mirroring Ostrasort.
