...
**Status:** P0 foundation + P1 placement law + **P2 Law milestone** (rooms/airtightness, certification, Ship Rating + law report) + **P3 Interop** (export as spawnable mod · template import · save-game import) shipped (2026-07-05). P4 QoL is next (§11).
