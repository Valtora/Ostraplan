...
reported to the maintainer privately through the repository's
[**Security** tab → *Report a vulnerability*](https://github.com/Valtora/Ostraplan/security/advisories/new),
which opens a private channel visible only to the maintainer. All complaints
