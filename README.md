...
*Plus **tabs**, so several designs are open at once and you can copy between them, PNG and SVG snapshots, light/dark theming, **UI scaling from 80% to 200%** — up for a high-resolution monitor run at 100% Windows scaling, down to fit more into the window you have — and an optional background update check.*
